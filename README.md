...
|:-------:|:---------:|
| `:1.10.1`, `:latest` | [View](variants/1.10.1) |
| `:1.10.1-jq-sops-ssh` | [View](variants/1.10.1-jq-sops-ssh) |
| `:1.10.1-jq-libvirt-sops-ssh` | [View](variants/1.10.1-jq-libvirt-sops-ssh) |
