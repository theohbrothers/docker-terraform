...
|:-------:|:---------:|
| `:1.11.0`, `:latest` | [View](variants/1.11.0) |
| `:1.11.0-jq-sops-ssh` | [View](variants/1.11.0-jq-sops-ssh) |
| `:1.11.0-jq-libvirt-sops-ssh` | [View](variants/1.11.0-jq-libvirt-sops-ssh) |
