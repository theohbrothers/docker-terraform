...
|:-------:|:---------:|
| `:1.13.2`, `:latest` | [View](variants/1.13.2) |
| `:1.13.2-jq-sops-ssh-step` | [View](variants/1.13.2-jq-sops-ssh-step) |
| `:1.13.2-jq-libvirt-sops-ssh-step` | [View](variants/1.13.2-jq-libvirt-sops-ssh-step) |
