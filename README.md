...
|:-------:|:---------:|
| `:1.14.7`, `:latest` | [View](variants/1.14.7) |
| `:1.14.7-jq-sops-ssh-step` | [View](variants/1.14.7-jq-sops-ssh-step) |
| `:1.14.7-jq-libvirt-sops-ssh-step` | [View](variants/1.14.7-jq-libvirt-sops-ssh-step) |
