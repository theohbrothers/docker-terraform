...
|:-------:|:---------:|
| `:1.13.4`, `:latest` | [View](variants/1.13.4) |
| `:1.13.4-jq-sops-ssh-step` | [View](variants/1.13.4-jq-sops-ssh-step) |
| `:1.13.4-jq-libvirt-sops-ssh-step` | [View](variants/1.13.4-jq-libvirt-sops-ssh-step) |
