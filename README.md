...
|:-------:|:---------:|
| `:1.14.8`, `:latest` | [View](variants/1.14.8) |
| `:1.14.8-jq-sops-ssh-step` | [View](variants/1.14.8-jq-sops-ssh-step) |
| `:1.14.8-jq-libvirt-sops-ssh-step` | [View](variants/1.14.8-jq-libvirt-sops-ssh-step) |
