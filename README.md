...
|:-------:|:---------:|
| `:1.13.3`, `:latest` | [View](variants/1.13.3) |
| `:1.13.3-jq-sops-ssh-step` | [View](variants/1.13.3-jq-sops-ssh-step) |
| `:1.13.3-jq-libvirt-sops-ssh-step` | [View](variants/1.13.3-jq-libvirt-sops-ssh-step) |
