...
|:-------:|:---------:|
| `:1.14.0`, `:latest` | [View](variants/1.14.0) |
| `:1.14.0-jq-sops-ssh-step` | [View](variants/1.14.0-jq-sops-ssh-step) |
| `:1.14.0-jq-libvirt-sops-ssh-step` | [View](variants/1.14.0-jq-libvirt-sops-ssh-step) |
